...
import { MapPin, AlertTriangle, Users, Clock, Settings, LogOut, UserPlus, Info } from 'lucide-react';
    ...
    >
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-4">
              <h1 className="text-xl font-semibold text-blue-600">SOS Nairobi</h1>
      ...
      <main className="max-w-7xl mx-auto py-8 px-6 lg:px-8">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-8">
          <TabsList className="grid w-full grid-cols-6 bg-white/80 backdrop-blur-sm border border-gray-200/50">
            <TabsTrigger value="overview" className="data-[state=active]:bg-blue-50 data-[state=active]:text-blue-600">Overview</TabsTrigger>
            <TabsTrigger value="cases" className="data-[state=active]:bg-blue-50 data-[state=active]:text-blue-600">Cases</TabsTrigger>
            <TabsTrigger value="analytics" className="data-[state=active]:bg-blue-50 data-[state=active]:text-blue-600">Analytics</TabsTrigger>
            <TabsTrigger value="resource-status" className="data-[state=active]:bg-blue-50 data-[state=active]:text-blue-600">Resource Status</TabsTrigger>
            <TabsTrigger value="team-availability" className="data-[state=active]:bg-blue-50 data-[state=active]:text-blue-600">Team Availability</TabsTrigger>
            <TabsTrigger value="collaboration-hub" className="data-[state=active]:bg-blue-50 data-[state=active]:text-blue-600">Collaboration Hub</TabsTrigger>
          </TabsList>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <Card className="bg-white/90 backdrop-blur-sm border-gray-200/50 hover:bg-white/95 transition-all duration-200">
                ...
                <CardContent className="pt-0">
                  ...
                  <p className="text-xs text-red-600 mt-1">-1 from last hour</p>
                </CardContent>
              </Card>
              ...
              <Card className="bg-white/90 backdrop-blur-sm border-gray-200/50 hover:bg-white/95 transition-all duration-200">
                ...
                <CardContent className="pt-0">
                  ...
                  <p className="text-xs text-green-600 mt-1">-0.5 min from avg</p>
                </CardContent>
              </Card>
            </div>
              ...
              <CardContent className="pt-0">
                <div className="space-y-4">
                  {recentCases.map((case_) => (
                    <div key={case_.id} className="flex items-center justify-between p-4 bg-gray-50/50 rounded-lg border border-gray-100/50 hover:bg-gray-50/70 transition-colors">
                      <div className="flex items-center space-x-4">
                        <div className="p-2 bg-white rounded-lg shadow-sm">
                          <case_.icon className="h-4 w-4 text-blue-600" />
                        </div>
                        <div>
                ...
                <div className="mt-6">
                  <Link to="/partner/cases">
                    <Button variant="outline" className="w-full bg-white/80 hover:bg-white text-blue-600 border-blue-200 hover:border-blue-300">
                      View All Cases
                    </Button>
                  </Link>
                </div>
            ...
            <Card className="bg-white/90 backdrop-blur-sm border-gray-200/50">
              ...
              <CardContent>
                <div className="text-center py-12">
                  ...
                  <Link to="/partner/cases">
                    <Button className="bg-blue-600 hover:bg-blue-700 text-white">Go to Case Management</Button>
                  </Link>
                </div>
              </CardContent>
            </Card>
          ...
          <TabsContent value="resource-status">
            <Link to="/partner/resource-status">
              <Card className="bg-white/90 backdrop-blur-sm border-gray-200/50 hover:bg-white/95 transition-all duration-200 cursor-pointer">
                <CardHeader>
                  <CardTitle className="text-lg font-semibold text-gray-900">Resource Status</CardTitle>
                  <CardDescription className="text-gray-600">Monitor available resources and equipment</CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="text-center py-8">
                    <Button className="bg-blue-600 hover:bg-blue-700 text-white">Manage Resources</Button>
                  </div>
                </CardContent>
              </Card>
            </Link>
          ...
          <TabsContent value="team-availability">
            <Link to="/partner/team-availability">
              <Card className="bg-white/90 backdrop-blur-sm border-gray-200/50 hover:bg-white/95 transition-all duration-200 cursor-pointer">
                <CardHeader>
                  <CardTitle className="text-lg font-semibold text-gray-900">Team Availability</CardTitle>
                  <CardDescription className="text-gray-600">View team schedules and availability status</CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="text-center py-8">
                    <Button className="bg-blue-600 hover:bg-blue-700 text-white">View Team Status</Button>
                  </div>
                </CardContent>
              </Card>
            </Link>
          ...
          <TabsContent value="collaboration-hub">
            <Link to="/partner/collaboration-hub">
              <Card className="bg-white/90 backdrop-blur-sm border-gray-200/50 hover:bg-white/95 transition-all duration-200 cursor-pointer">
                <CardHeader>
                  <CardTitle className="text-lg font-semibold text-gray-900">Collaboration Hub</CardTitle>
                  <CardDescription className="text-gray-600">Coordinate with other organizations and teams</CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="text-center py-8">
                    <Button className="bg-blue-600 hover:bg-blue-700 text-white">Open Collaboration Hub</Button>
                  </div>
                </CardContent>
              </Card>
            </Link>
