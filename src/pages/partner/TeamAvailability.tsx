...
const TeamAvailability = () => {
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      ...
      case 'On Call': return 'bg-blue-100 text-blue-700 border-blue-200';
    ...
    >
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-4">
              ...
              <h1 className="text-xl font-semibold text-gray-900">Team Availability</h1>
            </div>
            <div className="flex items-center space-x-4">
      ...
      <main className="max-w-7xl mx-auto py-8 px-6 lg:px-8">
        <div className="mb-8">
          ...
          <p className="text-gray-600">Monitor team schedules and availability status</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          ...
          <Card className="bg-white/90 backdrop-blur-sm border-gray-200/50">
            <CardHeader className="pb-3">
              <CardTitle className="text-sm font-medium text-gray-700">On Call</CardTitle>
            </CardHeader>
            <CardContent className="pt-0">
          ...
          <Card className="bg-white/90 backdrop-blur-sm border-gray-200/50">
            <CardHeader className="pb-3">
              <CardTitle className="text-sm font-medium text-gray-700">Busy</CardTitle>
            </CardHeader>
            <CardContent className="pt-0">
          ...
          <Card className="bg-white/90 backdrop-blur-sm border-gray-200/50">
            <CardHeader className="pb-3">
              <CardTitle className="text-sm font-medium text-gray-700">Off Duty</CardTitle>
            </CardHeader>
            <CardContent className="pt-0">
        ...
        <Card className="bg-white/90 backdrop-blur-sm border-gray-200/50">
          <CardHeader>
            ...
            <CardDescription className="text-gray-600">Current availability status of all team members</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">
              {teamMembers.map((member) => (
                <div key={member.id} className="flex items-center justify-between p-4 bg-gray-50/50 rounded-lg border border-gray-100/50 hover:bg-gray-50/70 transition-colors">
                  <div className="flex items-center space-x-4">
